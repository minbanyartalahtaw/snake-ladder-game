...
export default function CustomButton({ children, onClick, disabled = false, variant = 'primary', className = '' }: Prop) {
  const baseClasses = "px-6 py-3 font-semibold text-sm rounded-lg transition-all duration-200 cursor-pointer border";
